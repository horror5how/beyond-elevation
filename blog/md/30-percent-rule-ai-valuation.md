---
title: "The 30% Rule in AI: The Pricing Heuristic Every Investor Whispers But Nobody Writes Down"
...
**No data moat.** Generic AI companies building on public datasets and open-weight models deliver improvements that any funded competitor can replicate within six months. The 30% improvement evaporates as soon as a second player enters the market. The companies that sustain the advantage are those with proprietary training data, domain-specific datasets, or unique data pipelines that competitors cannot access. As our analysis of [AI moats](/blog/posts/ai-moat-not-just-the-model/) shows, the model is not the moat — the data and IP around it is.
