...
# 83% of Enterprise Value Is Intangible. Your Board Governs Zero Percent of It.
...
**3. IP maintenance efficiency.** The ratio of IP maintenance costs (patent prosecution, renewal fees, trade secret programme costs) to estimated IP portfolio value. Companies spending more than 8-12% of portfolio value on maintenance are typically over-maintaining low-value assets — a finding Hayat Amin's [IP Defensibility 7-Point Test](/blog/posts/ip-defensibility-assessment-framework/) catches in the first diagnostic session.
