...
Hayat Amin's view is direct: "Tax counsel optimizes for the IRS. Nobody optimizes for the lender who runs DEMPE three years later. By the time founders discover the mismatch, the cost is 10x what the tax savings were worth." This is not a criticism of the holdco structure itself. The [IP holding company structure](/blog/posts/ip-holdco-structure-guide/) remains powerful when the holdco actually performs DEMPE functions. The problem is that most founder holdcos were set up as empty shells.
...
Companies that fix the mismatch before due diligence avoid the discount entirely. Companies that discover it during due diligence pay for it in the purchase price. The cost of [IP due diligence](/blog/posts/ip-due-diligence-for-acquirers/) that catches this early runs $25K to $50K. The cost of missing it runs seven figures.
...
**Path 2: Collapse the structure.** Assign the IP back to the operating company and accept the standard tax treatment. This eliminates the DEMPE mismatch entirely. For companies where the annual tax savings from the holdco structure are less than $200K, this is almost always the right move. The simplification makes lending, [IP-backed financing](/blog/posts/ip-backed-financing-patents-as-collateral/), and M&A due diligence faster and cheaper.
...
[Book the diagnostic →](/call/web?ref=blog-ip-holdco-dempe-valuation-trap-2026)
