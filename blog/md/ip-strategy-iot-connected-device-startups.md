...
**Layer 3: Connectivity and protocol.** Wi-Fi, Bluetooth, Zigbee, Thread, Matter, 5G, LoRaWAN. Every wireless protocol carries standard-essential patent obligations. An IoT startup shipping a Wi-Fi-enabled device is automatically a licensee of the [SEP holders in that standard](/blog/posts/sep-licensing-frand-explained/). The question is not whether you owe royalties. It is whether you have budgeted for them, negotiated favorable terms, and built a cross-licensing position to offset the cost.
...
**Layer 5: Data and telemetry.** The continuous stream of sensor data, usage patterns, and environmental readings your devices collect. This is the fastest-appreciating asset in the stack. [Structured IoT data](/blog/posts/data-monetization-strategy-framework/) can be licensed to insurers, urban planners, supply chain operators, and AI training providers without selling a single additional device.
...
The licensing cost is real and unavoidable. A cellular IoT module attracts royalty obligations to multiple [patent pool](/blog/posts/patent-pool-court-set-royalty-implementer-2026/) licensors before the product generates a dollar of revenue. Founders who ignore inbound SEP exposure discover it as a surprise cost item that compresses margins by 3-8% per unit.
...
[Book the diagnostic →](/call/web?ref=blog-ip-strategy-iot-connected-device-startups)
