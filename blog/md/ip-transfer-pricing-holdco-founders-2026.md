...
**DEMPE functional analysis.** Under the 2022 OECD DEMPE framework (Development, Enhancement, Maintenance, Protection, Exploitation), economic ownership of IP follows the entity that performs the DEMPE functions, not the entity holding legal title. Hayat Amin showed this in practice when a client's Luxembourg IP holdco held 14 patents but performed zero DEMPE functions. The tax authority attributed 100% of IP income back to the operating subsidiary. Beyond Elevation's [DEMPE holdco analysis](/blog/posts/ip-holdco-dempe-valuation-trap-2026/) details why legal title without operational substance is worthless.
...
[Book the diagnostic →](/call/web?ref=blog-ip-transfer-pricing-holdco-founders-2026)
