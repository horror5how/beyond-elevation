...
The seven: Arbutus Biopharma, Acuitas Therapeutics, Moderna, BioNTech, Alnylam Pharmaceuticals, Genevant Sciences, and CureVac. Each holds patents covering different layers of the LNP delivery system. The question for any company entering the mRNA space — or investing in one — is which patents are still enforceable, which are expiring, and where the [white space](/blog/posts/white-space-analysis-patents/) sits.
...
[Book the diagnostic →](/call/web?ref=blog-mrna-delivery-patent-landscape)
