...
Use it when the patent has a licensing programme, a product revenue stream it protects, or a demonstrable competitive advantage that commands margin. Software, AI, and SaaS patents almost always land here because the revenue linkage is measurable. The [income approach to patent valuation](/blog/posts/income-approach-patent-valuation/) requires rigorous cash-flow modelling with defensible discount rates.
...
**Step 2:** Run the income approach on every patent tied to a product or licensing programme. Use the [patent value calculation formula](/blog/posts/patent-value-calculation-formula/) as your starting framework.
...
[Book the diagnostic →](/call/web?ref=blog-what-is-patent-valuation)
...
Patent valuation focuses specifically on patents and patent portfolios. [IP valuation](/blog/posts/ip-valuation-methods-explained/) is broader — it includes patents, trademarks, copyrights, trade secrets, and data assets. Patent valuation is a subset of IP valuation, but it uses the same four core methods: cost, market, income, and real options.
