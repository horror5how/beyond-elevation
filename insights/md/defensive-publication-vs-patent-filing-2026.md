...
# Defensive Publication vs Patent Filing: The $0 IP Move That Blocks Competitors From Patenting Your Invention
...
**Condition 3: Cost-benefit math.** Filing, prosecuting, and maintaining a single patent through its 20-year life costs $50,000 to $100,000 across US, European, and Asian jurisdictions. If the invention will never generate licensing revenue and will never be the basis for an injunction against a competitor, that money is better spent on patents that protect your core IP. [Beyond Elevation](https://beyondelevation.com) routinely identifies three to five defensive publication candidates per client portfolio that redirect $150,000 or more toward higher-value filings.
...
Hayat Amin's Patent-vs-Publish Decision Framework is a four-question diagnostic that separates inventions worth patenting from inventions worth publishing defensively. [Beyond Elevation](https://beyondelevation.com) runs this test across every innovation in a client's pipeline before allocating filing budget.
...
**Question 4: Will this invention's commercial value increase over the next 5 years?** If uncertain or yes, file a [provisional patent](/blog/posts/provisional-patent-12-month-strategy/) to buy 12 months of assessment time before committing. If confidently no, publish defensively and redirect the filing budget to your core IP.
...
This hybrid approach achieves three outcomes simultaneously. It builds a [defensible patent portfolio](/blog/posts/ip-defensibility-assessment-framework/) around your core moat. It creates a wall of prior art that prevents competitors from assembling patent positions around your product. And it cuts total IP budget by 40 to 60% by eliminating filings that would never generate commercial returns.
...
A defensive publication does not invalidate existing patents held by others. It prevents new patents from being issued on the published technology. If a competitor already holds a patent covering the technology, your defensive publication has no effect on their granted claims. For protection against existing patents, you need a [freedom-to-operate analysis](/blog/posts/freedom-to-operate-patent-clearance/).
