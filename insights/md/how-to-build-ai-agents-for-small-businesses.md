...
Before you build, move the missing piece into a system with an API. That's usually your accounting package, your customer record or your job management tool. If nothing holds it, the agent build stops and a data build starts. That's an unwelcome answer, and it's the honest one.
