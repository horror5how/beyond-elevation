...
IP filing is aligned with the product roadmap and competitive landscape. The company has an invention disclosure process, a patent committee or [fractional IP strategist](/blog/posts/fractional-ip-strategist-for-startups/), and a 12-to-18-month filing roadmap that prioritises claims by competitive impact rather than technical novelty. Trade secrets are formally identified and protected with access controls, NDAs, and documentation protocols.
...
**Month 1-2: Run a full IP audit.** Map every protectable innovation across your product, data, and process layers. Include trade secrets, know-how, and data assets — not just patents. Use the [IP audit checklist](/blog/posts/ip-audit-checklist-hidden-assets/) to ensure coverage. Most companies discover 3-to-5x more protectable IP than they expected.
...
**Month 5-8: Execute the strategic filing roadmap.** File on the innovations that create the most competitive distance — the ones a well-funded competitor would need 18-to-24 months to replicate. Prioritise broad claims over narrow ones. Cluster filings around your core technology to build a [patent cluster moat](/blog/posts/patent-clustering-strategy-moat/) rather than isolated filings that a competitor can design around individually.
