...
**Step 4: Create a bifurcated IP schedule.** Separate university-licensed IP from startup-owned IP. Present this bifurcated schedule in your [data room](/blog/posts/ip-strategy-startups-guide/). Investors understand mixed portfolios — what they do not tolerate is ambiguity about which assets sit in which category.
...
That sequence — negotiate, file, present — is the difference between a spinout that raises at a premium and one that raises at a discount. [Beyond Elevation](https://beyondelevation.com) runs university spinout IP audits that map ownership, flag Bayh-Dole exposure, and build the bifurcated IP schedule investors require. Book an [IP strategy consultation](/blog/posts/ip-backed-ma-positioning/) before your TTO meeting, not after.
