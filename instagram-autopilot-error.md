# Instagram Autopilot — BLOCKED: Expired Token (updated 2026-07-06)
...
Confirmed from GH Actions run #28790401158 (2026-07-06T12:09:31Z):
```
Error: IG token expired: Session has expired on Thursday, 25-Jun-26 23:32:48 PDT.
The current time is Monday, 06-Jul-26 05:09:31 PDT.
code: 190
```

Run history: June 28, 29, 30, July 1, 2 (×2), July 3 (×3), July 4, July 6 — all FAILED with same error 190.
...
- **Slides**: 6 slides rendered and committed (GH Actions run #28790401158)
...
---
*Last updated: 2026-07-06 by cloud autopilot session (run #28790401158)*
